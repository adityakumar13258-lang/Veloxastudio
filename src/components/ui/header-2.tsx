		...
		>
			...
			>
				<Link to="/" className="flex items-center gap-2">
					<span className="text-xl font-bold tracking-tight font-display">VeloxaStudio</span>
				</Link>
				<div className="hidden items-center gap-2 md:flex">
					...
					<Button asChild className="text-black"><Link to="/enquiry">Get Started</Link></Button>
				</div>
			...
			>
				...
				>
					...
					<div className="flex flex-col gap-2">
						<Button asChild className="w-full text-black"><Link to="/enquiry" onClick={() => setOpen(false)}>Get Started</Link></Button>
					</div>
				</div>
			</div>
		</header>
